        ...
        <div className="playlist">
            <div className="playlist-body">
                <div className="playlist-bar-head">
                    <div style={{ backgroundImage: `url(${currentSong.cover})` }} className="playlist-img"></div>
                ...
                <div className="playlist-bar-end">
                    <div className="playlist-controller">
                        <button onClick={() => skipTrackHandler('skip-back')}><ion-icon name="play-skip-back"></ion-icon></button>
                        <button onClick={playSongHandler} ><ion-icon name={`${isPlaying ? 'pause-outline' : 'play' }`}></ion-icon></button>
                        <button onClick={() => skipTrackHandler('skip-forward')}><ion-icon name="play-skip-forward"></ion-icon></button>
